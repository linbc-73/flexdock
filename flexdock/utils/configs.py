...
def config_from_args(args: argparse.Namespace) -> DictConfig:
    ...
    transforms_config = {
        ...
        "protein": {
            ...
            "sc_sigma_mode": getattr(args, "sc_sigma_mode", "fixed"),
            "class_sigma_scales": getattr(args, "class_sigma_scales", [0.5, 1.0, 2.0]),
        },
        "residue_rmsd_bins": getattr(args, "residue_rmsd_bins", None),
        "flexibility_metric": getattr(args, "flexibility_metric", "residue_rmsd"),
        "pocket": {
    ...
    loss_config = {
        ...
        "residue_rmsd_weight": getattr(args, "residue_rmsd_weight", 0.0),
        "flexible_backbone": args.flexible_backbone,
        "flexible_sidechains": args.flexible_sidechains,
        "no_torsion": args.no_torsion,
